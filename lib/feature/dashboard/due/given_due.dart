...
class GivenDue extends StatefulWidget {
  ...
  @override
  State<GivenDue> createState() => _GivenDueState();
}

class _GivenDueState extends State<GivenDue> {
  File image;
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary:
                          dueTypeFlagGet == 0 ? DEFAULT_BLUE : Colors.white,
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary:
                          dueTypeFlagGiven == 1 ? DEFAULT_BLUE : Colors.white,
                      fixedSize: Size(width, 50),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                    borderSide:
                        new BorderSide(color: Colors.grey.withOpacity(.35)),
