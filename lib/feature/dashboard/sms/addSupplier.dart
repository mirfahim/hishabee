                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                initialValue: controller.nameForContact.value,
                                validator: (value) {
                                  if (value.isEmpty) {
                          ...
                          child: Container(
                            ...
                            child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  initialValue: controller.contactMobileNumber.value,
                                  validator: (value) {
                                    if (value.isEmpty) {
                      ...
                      "SAVE",
                          () {
                            if (formKey.currentState.validate()) {
                              ...
                              controller.mobileController.text = null;
