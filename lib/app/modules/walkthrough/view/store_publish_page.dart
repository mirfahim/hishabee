...
import 'package:hishabee_business_manager_fl/app/modules/single_shop/online_shop/presentation/pages/change_banner_page.dart';
import 'package:hishabee_business_manager_fl/app/modules/single_shop/online_shop/presentation/pages/online_shop_link_page.dart';
import 'package:hishabee_business_manager_fl/app/modules/single_shop/online_shop/presentation/pages/online_shop_social_media_link_page.dart';
import 'package:hishabee_business_manager_fl/app/modules/walkthrough/manager/store_publish_controller.dart';

class StorePublishPage extends GetView<StorePublishController> {
  @override
                      ...
                      child: Stack(
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              var value;
                              controller.storePublished.value = true;
                              await controller.storePublishToggle();
                              value = controller.storePublished.value;
                              if (value == true) {
                                Fluttertoast.showToast(
                                    msg: "Your Shop published");
