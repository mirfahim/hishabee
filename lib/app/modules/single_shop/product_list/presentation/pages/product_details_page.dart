          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Divider(thickness: 1.5,color: Color(0xFFC4C4C4).withOpacity(.35),),
                SizedBox(
                  height: 10,
                ),
                Row(
                ...
                SizedBox(height: 20,),
                Text('other_details_of_product'.tr, style: TextStyle(
                  fontFamily: 'Roboto',
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF185ADB),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text("current_stock".tr,style: TextStyle(fontSize: 14, fontFamily: 'Roboto'),),
                        Text(': ${controller.product.value.stock}',style: TextStyle(fontSize: 14, fontFamily: 'Roboto'),)
                      ],
                    )
                  ],
                ),
