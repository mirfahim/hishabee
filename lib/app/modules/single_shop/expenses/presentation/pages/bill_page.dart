...
class BillPage extends GetView<AddExpenseController> {
  @override
                      ...
                      child: ListView(
                        children: [
                          ...
                          Padding(
                            ...
                            child:
                                getDefaultBlueButton(context, "SAVE", () async {
                              if (controller.billFormKey.currentState
                                  .validate()) {
                                controller.billFormKey.currentState.save();
                                await controller.addExpense("Bill");
