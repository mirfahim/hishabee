            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: TextField(
                    onChanged: (number) {
                      controller.mobileNumbers.value = number;
                    },
                ...
                Padding(
                  ...
                  child: Obx(() {
                    return TextField(
                      ...
                      onChanged: (text) {
                        // setState(() {
                        controller.textInTheMessageField.value = text;
                        // });
                        RegExp exp = RegExp("[A-Za-z0-9]");
                        if (exp.hasMatch(text.substring(0)) &&
                            text.substring(0) != " ") {
                          // setState(() {
                          controller.maxLengthForText.value = 160;
                          // });
                          if ((text.length / 160) <= 1) {
                            ...
                            // });
                              ...
                              (text.length / 160) < 2) {
                            // setState(() {
                            controller.messageCount.value = 2;
                            // });
                          } else if ((text.length / 160) > 2 &&
                              (text.length / 160) < 3) {
                            // setState(() {
                            controller.messageCount.value = 3;
                            // });
                          }
                        } else {
                          // setState(() {
                          controller.maxLengthForText.value = 70;
                          // });
                          if ((text.length / 70) <= 1) {
                            // setState(() {
                            controller.messageCount.value = 1;
                      ...
                      decoration: InputDecoration(
                        helperText:
                            '${controller.textInTheMessageField.value.length} Characters | ${controller.messageCount.value} Messages | (${controller.maxLengthForText.value}/1 messages)',
                        labelText: 'Message',
                        focusColor: Colors.black,
                        border: OutlineInputBorder(
                          borderSide: BorderSide(width: 2, color: Colors.black),
