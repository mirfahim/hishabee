...
import 'package:hishabee_business_manager_fl/app/modules/single_shop/transaction_and_refund/presentation/manager/exchange_tabs_controller.dart';
...
class ExchangeSellPage extends StatefulWidget {
  @override
  _ExchangeSellPageState createState() => _ExchangeSellPageState();
}

class _ExchangeSellPageState extends State<ExchangeSellPage> {
  ExchangeSellController sellController;
  ExchangeTabsController tabsController;

  void initState() {
    super.initState();
    AnalyticsService.sendAnalyticsToServer(event: AnalyticsEvent.sellStarted);
    sellController = Get.find();
    tabsController = Get.put(ExchangeTabsController(), tag: '1');
  }
...
openBottomSheet(
    BuildContext context, Size size, ExchangeSellController controller) {
...
List<Tab> getTabs(ExchangeSellController controller) {
  List<Tab> tabs = <Tab>[];
...
List<Widget> getTabBarViews(
    Size size,
    ExchangeSellController controller,
...
Widget buildTabBody(
  ...
  final ExchangeSellController sellController = Get.find();
...
class SearchBarWidget extends StatelessWidget {
  ...
  final Size size;
  final ExchangeTabsController tabsController;

  @override
  Widget build(BuildContext context) {
    final sellController = Get.find<ExchangeSellController>();
    return Padding(
      padding: const EdgeInsets.only(
        top: 76.0,
        right: 10,
