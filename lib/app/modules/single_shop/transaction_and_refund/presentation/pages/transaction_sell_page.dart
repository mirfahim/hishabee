...
import 'package:hishabee_business_manager_fl/app/modules/single_shop/transaction_and_refund/presentation/manager/transaction_tabs_controller.dart';
...
class TransactionSellPage extends StatefulWidget {
  @override
  _TransactionSellPageState createState() => _TransactionSellPageState();
}

class _TransactionSellPageState extends State<TransactionSellPage> {
  TransactionSellController sellController;
  TransactionTabsController tabsController;

  void initState() {
    super.initState();
    AnalyticsService.sendAnalyticsToServer(event: AnalyticsEvent.sellStarted);
    sellController = Get.find();
    tabsController = Get.put(TransactionTabsController(), tag: '1');
  }
                                  ...
                                  Container(
                                    ...
                                    child: TabBar(
                                      ...
                                      onTap: (index) {
                                        if (index > 0) {
                                          setState(() {
                                            tabsController = Get.find<
                                                    TransactionTabsController>(
                                                tag: '$index');
...
openBottomSheet(
    BuildContext context, Size size, TransactionSellController controller) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "tk".tr + "  ${product.stock * product.sellingPrice}",
...
List<Tab> getTabs(TransactionSellController controller) {
  List<Tab> tabs = <Tab>[];
...
List<Widget> getTabBarViews(
    Size size,
    TransactionSellController controller,
...
Widget buildTabBody(
  ...
  final TransactionSellController sellController = Get.find();
...
class SearchBarWidget extends StatelessWidget {
  ...
  final Size size;
  final TransactionTabsController tabsController;

  @override
  Widget build(BuildContext context) {
    final sellController = Get.find<TransactionSellController>();
    return Padding(
      padding: const EdgeInsets.only(
        top: 76.0,
        right: 10,
