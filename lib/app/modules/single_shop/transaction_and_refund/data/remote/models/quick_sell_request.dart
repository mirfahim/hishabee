...
QuickSellRequest quickSellRequestFromJson(String str) =>
    QuickSellRequest.fromJson(json.decode(str));

String quickSellRequestToJson(QuickSellRequest data) =>
...
class QuickSellRequest {
  ...
  factory QuickSellRequest.fromJson(Map<String, dynamic> json) =>
      QuickSellRequest(
        ...
        transactionUniqueId: json["transaction_unique_id"] == null
            ? null
            : json["transaction_unique_id"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "transaction_unique_id":
            transactionUniqueId == null ? null : transactionUniqueId,
