...
AddTransactionRequest addTransactionRequestFromJson(String str) =>
    AddTransactionRequest.fromJson(json.decode(str));

String addTransactionRequestToJson(AddTransactionRequest data) =>
...
class AddTransactionRequest {
  ...
  factory AddTransactionRequest.fromJson(Map<String, dynamic> json) =>
      AddTransactionRequest(
        ...
        receivedAmount:
            json["received_amount"] == null ? null : json["received_amount"],
        changeAmount:
