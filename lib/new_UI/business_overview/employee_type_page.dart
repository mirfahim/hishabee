...
class EmployeReportPage extends StatefulWidget {
  @override
  _EmployeReportPageState createState() => _EmployeReportPageState();
}

class _EmployeReportPageState extends State<EmployeReportPage> {
  int flag = 1;
